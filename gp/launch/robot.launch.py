...
# Function to create the ros2 control node
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            TimerAction(period=3.0, actions=[LogInfo(msg="Starting controller manager node"), controller_manager_node]),  # Delayed start of the controller manager node
